...
var FindDndClassController = /** @class */ (function () {
    ...
    FindDndClassController.prototype.execute = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var playableClass, proficiencyChoices, classProficiencies, classReturner, i, position, fromProficiencies, proficiencies, i, urlIndex, itemProficiency, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        classProficiencies = playableClass.proficiencies;
                        classReturner = {
                        ...
                        _a.label = 2;
                    case 2:
                        if (!(i < classProficiencies.length)) return [3 /*break*/, 5];
                        urlIndex = classProficiencies[i].index;
                        return [4 /*yield*/, this.findItemProficiencies.execute("/proficiencies/" + urlIndex)];
                    case 3:
                        itemProficiency = _a.sent();
                    ...
                    case 4:
                        i++;
                        return [3 /*break*/, 2];
                    case 5: return [2 /*return*/, res.status(200).json(classReturner)];
                    case 6:
                        error_1 = _a.sent();
